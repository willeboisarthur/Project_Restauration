...
class FramePrincipal : public wxFrame
{
	...
	protected:
		...
		wxButton* m_button_scolaire;
		wxButton* m_button_inconnu;
		wxButton* m_button_invalide;
	...
	public:
		...
		FramePrincipal( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("CodeLite 14 wxFB 3.9 wxW 3.0"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,500 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
